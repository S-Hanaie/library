...
<head>
    ...
    <title>سامانه آنلاین مدیریت کتابخانه|لیست کتاب ها</title>
...
<body class="hold-transition sidebar-mini layout-fixed text-center">
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">لیست کتاب ها </h4>
    </div>
...
<p style="color:red;">کتاب قبلا امانت گرفته شده است</p>
<?php endif;?>
                            </div>
